...
class OrdersWorker
{
  var ordersStore: OrdersStoreProtocol
    ...
    // Constructor
    init(ordersStore: OrdersStoreProtocol) //-> constructor dependency injection: This technique of passing a different object that conforms to the same protocol as required by the OrdersWorker’s initializer (or constructor)
  {
